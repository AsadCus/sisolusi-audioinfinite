...
const FEATURES = [
  {
    ...
    description:
      "Every product passes a 47-point quality inspection before leaving our facility. Studio-grade components, built to last a decade.",
  },
  {
    id: 2,
    number: "02",
    title: "Trusted Brand",
    description:
      "Over a decade of excellence in professional audio. Trusted by recording studios, broadcasters, and sound engineers worldwide.",
  },
  {
    id: 3,
    number: "03",
    title: "Fast Delivery",
    description:
      "Nationwide shipping with real-time tracking. Orders before 2PM ship same day, packaged with military-spec foam protection.",
  },
  {
    id: 4,
    number: "04",
    ...
    description:
      "Dedicated audio specialists available 24/7 — real engineers who understand your needs, not generalists reading from a script.",
  },
];
...
function FeatureCard({
  ...
  return (
    <div
      ref={ref}
      className="group border-t border-neutral-200 pt-8 pb-10 hover:bg-neutral-50 transition-colors duration-300 -mx-1 px-1"
      style={{
        opacity: visible ? 1 : 0,
...
export function FeaturesSection() {
  return (
    <section
      id="about"
      className="section-pad bg-neutral-50 border-t border-neutral-200">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-16">
          ...
          <div className="flex items-end">
            <p className="text-[15px] text-neutral-600 leading-relaxed max-w-md">
              We combine cutting-edge engineering with exceptional craftsmanship
              to deliver audio solutions that exceed the expectations of the
              world&apos;s most demanding professionals.
            </p>
          </div>
        </div>
