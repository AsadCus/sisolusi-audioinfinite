...
const SERVICES = [
  {
    ...
    description:
      "We manufacture to your exact specs — logo, packaging, and materials. Built for brands that want to sell under their own identity.",
    features: [
      "Logo Branding",
      "Custom Packaging",
      "Color Options",
  ...
  },
  {
    ...
    description:
      "From concept to production, we handle everything. Share your requirements and we'll engineer a solution tailored to your market.",
    features: [
      "Concept Design",
      "Spec Confirmation",
      "Full Customization",
  ...
  },
  {
    ...
    description:
      "Our team of audio engineers provides ongoing technical support, warranty service, and product training for your team.",
    features: [
      "24/7 Support",
      "On-site Training",
      "Warranty Service",
    ...
    <section
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-16">
          <div>
            <p className="text-[10px] tracking-[0.2em] uppercase font-medium text-neutral-400 mb-4">
              Ready to Begin
            </p>
            <h2
          ...
          <div className="flex flex-col justify-end gap-8">
            <p className="text-[15px] text-neutral-600 leading-relaxed max-w-md">
              Whether you&apos;re building a professional studio, upgrading your live
              rig, or sourcing equipment for a large-scale venue — our
            ...
            <div
              ...
              <ul className="space-y-2.5">
                {service.features.map((feat) => (
                  <li
                    key={feat}
                    className="flex items-center gap-3 text-[12px] text-neutral-400">
