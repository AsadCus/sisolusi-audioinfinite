...
const TESTIMONIALS = [
  {
    id: 1,
    quote:
      "The Studio Monitor Pro redefined our mixing workflow entirely. The flat response is genuinely flat — no marketing fluff. Every mix we've done since translates perfectly to every playback system.",
  ...
  },
  {
    id: 2,
    quote:
      "We outfitted our entire broadcast facility with Audio Infinite equipment. The reliability under 18-hour live broadcast days is unmatched. Support team is exceptional — they know their products intimately.",
    author: "Priya Mehta",
  ...
  },
  {
    id: 3,
    quote:
      "I have been podcasting for six years and nothing has elevated my show quality like the Condenser Mic X1. The warmth and clarity make post-production almost unnecessary.",
    author: "Marcus Allen",
    role: "Podcast Host",
  ...
  },
  {
    id: 4,
    quote:
      "For our concert venue, we needed a system that could handle both intimate acoustic sets and high-energy performances. Audio Infinite delivered a tailored solution that exceeded every brief we set.",
    author: "Yuki Tanaka",
        ...
        <div className="grid lg:grid-cols-[2fr_5fr] gap-16 lg:gap-24">
          <div>
            ...
            <p className="mt-5 text-[13px] text-neutral-400 leading-relaxed">
              Professionals across the industry trust Audio Infinite to deliver
            ...
            <div className="mt-12 flex flex-col gap-3">
              {TESTIMONIALS.map((t, i) => (
                <button
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-medium transition-all duration-300 shrink-0 ${
                      active === i
                  ...
                  <div>
                    <div
                      className={`text-[12px] font-medium transition-colors duration-200 ${active === i ? "text-neutral-900" : "text-neutral-400 group-hover:text-neutral-700"}`}>
                      {t.author}
                    </div>
              ...
              {TESTIMONIALS.map((_, i) => (
                <button
                  ...
                  className={`transition-all duration-300 rounded-full ${
                    i === active
                      ? "w-6 h-0.75 bg-neutral-900"
                      : "w-0.75 h-0.75 bg-neutral-200 hover:bg-neutral-400"
                  }`}
                />
              ))}
            </div>
