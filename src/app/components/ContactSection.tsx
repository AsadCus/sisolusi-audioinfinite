...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="section-pad bg-white border-t border-neutral-200">
        ...
        <div className="grid lg:grid-cols-[2fr_3fr] gap-16 lg:gap-24">
          <div>
            ...
            <p className="text-[15px] text-neutral-400 leading-relaxed mb-12 max-w-sm">
              Whether you have a question about a product, need a custom
              solution, or simply want to discuss your next audio project —
              we&apos;re here.
            </p>
            ...
            <div className="space-y-6">
              {CONTACT_INFO.map((info) => (
                <div
                  key={info.label}
                  className="flex items-start gap-5 border-b border-neutral-100 pb-6 last:border-b-0 last:pb-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-[10px] tracking-[0.16em] uppercase text-neutral-400 mb-2">
                      Full Name
                    </label>
                    <input
                      id="name"
